...
import { Loader2, MoreHorizontal, Edit, Trash2, PlusCircle, Package } from 'lucide-react';
...
export default function InventoryPage() {
    ...
    const handleFormSuccess = (updatedProduct: Product) => {
        ...
        toast({ title: `Product ${action} successfully`, description: `The product details have been ${action}.` });
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardContent className="p-0">
                    {isLoading ? (
                        <div className="flex justify-center items-center h-64"><Loader2 className="h-6 w-6 animate-spin" /></div>
                    ) : products.length > 0 ? (
                        <Table>
                            <TableHeader>
                                <TableRow>
                                        ...
                                        <TableCell className="text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent>
                                                    ...
                                                    <DropdownMenuItem onClick={() => handleOpenDeleteDialog(product)} className="text-destructive"><Trash2 className="mr-2 h-4 w-4" /> Delete</DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
                                        </TableCell>
                                    </TableRow>
             ...
             <Dialog open={isFormOpen} onOpenChange={(isOpen) => {
                ...
                <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription>{selectedProduct ? 'Update the details for this product.' : 'Fill in the form to add a new product.'}</DialogDescription>
                    </DialogHeader>
                    <ProductForm product={selectedProduct || undefined} onSuccess={handleFormSuccess} />
                </DialogContent>
            </Dialog>
