...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0D121C] p-4">
      <Card className="w-full max-w-sm shadow-2xl bg-[#151A27] border-gray-800">
        ...
        <form onSubmit={handleLogin}>
          <CardContent className="space-y-4">
            ...
            <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white" type="submit">
        ...
        <div className="px-6 pb-6 space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#151A27] px-2 text-muted-foreground">
                  Demo Accounts
                </span>
              </div>
            </div>
            ...
            <Button variant="outline" className="w-full" onClick={() => handleDemoLogin('customer')}>
             ...
             <div className="text-center text-xs text-muted-foreground/80">
                <p>Master Admin: <code className="bg-muted p-1 rounded-sm">admin@accountech.com</code></p>
                <p>Client: <code className="bg-muted p-1 rounded-sm">client@techcorp.com</code></p>
             </div>
        </div>
      </Card>
    </div>
