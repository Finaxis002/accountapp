...
export function InvoicePreview({ transaction, company, party }: InvoicePreviewProps) {
            ...
            <DialogFooter className="p-6 pt-4 bg-background border-t flex-col sm:flex-row items-center gap-4">
                <div className='flex-1'>
                     <div className="flex items-center gap-2">
                        ...
                        <label className="text-sm font-medium text-muted-foreground">Invoice Template</label>
                    </div>
                </div>
