...
export function TransactionsTab({ selectedClient, selectedCompanyId, companyMap }: TransactionsTabProps) {
  ...
  const [sales, setSales] = React.useState<Transaction[]>([]);
     ...
     React.useEffect(() => {
        async function fetchTransactions() {
            ...
            try {
                ...
                setSales((salesData.entries || salesData || []).map((s: any) => ({ ...s, type: 'sales' })));
    ...
    const tableColumns = React.useMemo(() => columns({ onDownload: handleAction, onEdit: handleAction, onDelete: handleAction, companyMap }), [companyMap]);
