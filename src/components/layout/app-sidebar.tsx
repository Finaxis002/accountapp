...
import { LayoutGrid, BarChart2, ChevronDown, LogOut, ArrowRightLeft, FileText, FileBarChart2, Users, Settings, Shield } from 'lucide-react';
...
import { SidebarMenuSub, SidebarMenuSubItem, SidebarMenuSubButton } from '../ui/sidebar';
...
export function AppSidebar() {
  ...
  const adminMenu = (
    <>
      ...
      <SidebarMenuItem>
          <SidebarMenuButton asChild isActive={isActive('/admin/client-management')} tooltip="Client Management">
      ...
      <SidebarMenuItem>
          <SidebarMenuButton asChild isActive={isActive('/admin/permissions')} tooltip="Permissions">
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="p-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500">AccounTech Pro</h1>
        </div>
      ...
      {currentUser && (
        <div className="p-4 space-y-4 border-t border-sidebar-border">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-sm font-semibold">{currentUser?.role === 'master' ? 'Master Administrator' : currentUser?.name}</p>
