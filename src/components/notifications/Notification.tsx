...
//       const clientId = user.clientId || user.clientID || user.client;
...
//         // For clients/customers, use their client ID if available, otherwise user ID
//         const idToUse = clientId || userId;
//         apiUrl = `${baseURL}/api/notifications/client/${idToUse}`;
//         console.log("🔗 Using client API URL:", apiUrl);
//       } else {
//         apiUrl = `${baseURL}/api/notifications/user/${userId}`;
//         console.log("🔗 Using user API URL:", apiUrl);
//       }
...
//                         {formatDate(notification.metadata.createdAt)}
//                       </p>
//                     </div>
//                   </div>
//                 </div>
