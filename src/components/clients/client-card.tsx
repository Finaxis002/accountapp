      ...
      <CardContent className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
        ...
        <div className="text-right">
             <Badge 
                variant="outline"
                className={cn("text-xs font-semibold border",
                    client.subscriptionPlan === 'Premium' && 'bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-500/20 dark:text-purple-400 dark:border-purple-500/30',
                    client.subscriptionPlan === 'Standard' && 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-500/20 dark:text-blue-400 dark:border-blue-500/30',
                    client.subscriptionPlan === 'Basic' && 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-500/20 dark:text-gray-400 dark:border-gray-500/30'
                )}
            >
