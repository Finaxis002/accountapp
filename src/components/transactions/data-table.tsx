...
export function DataTable<TData, TValue>({
          ...
          >
            <div className="space-y-4">
              {row.getVisibleCells().map((cell) => (
                <div
                  key={cell.id}
                  className="flex justify-between items-center py-2 px-3 rounded-lg bg-gray-40/30 dark:bg-gray-750/30 hover:bg-gray-100/50 dark:hover:bg-gray-700/40 transition-colors duration-300"
                >
  ...
  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-5 mt-6 bg-gradient-to-r from-gray-50 to-gray-100/30 dark:from-gray-800 dark:to-gray-900/50 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm">
    <div className="text-sm text-gray-600 dark:text-gray-300 flex items-center gap-2">
      ...
      <span className="text-gray-500 dark:text-gray-400">items selected</span>
    </div>
