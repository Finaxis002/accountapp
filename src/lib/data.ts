...
export const invoices: Invoice[] = [
  {
    ...
    items: [{ description: "Payment for project alpha", amount: 5000.0 }],
    status: "Paid",
  },
  {
    id: "inv_2",
    ...
    items: [{ description: "Logo design services", amount: 1200.0 }],
    status: "Paid",
  },
  {
    id: "inv_3",
    ...
    items: [{ description: "Data analysis consultation", amount: 2500.0 }],
    status: "Pending",
  },
];
